...
export default function OptionsPage({ opts }) {
  return (
      ...
      <main className="flex-grow py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <p className="text-sm sm:text-base text-center text-white">
            Discover the essence of Sikhism through our curated collection of Keertan (devotional hymns),
            Katha (spiritual discourses), and Paath (scripture recitations). Immerse yourself in the
            timeless wisdom and beauty of Sikh traditions.
          </p>
